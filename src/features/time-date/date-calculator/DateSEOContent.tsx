...
interface DateSEOContentProps {
  translations: DateSEOTranslations
}

export function DateSEOContent({ translations: t }: DateSEOContentProps) {
  return (
