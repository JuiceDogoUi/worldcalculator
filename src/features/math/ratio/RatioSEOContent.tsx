interface RatioSEOContentProps {
  translations: {
    whatIsTitle: string
...
export function RatioSEOContent({ translations: t }: RatioSEOContentProps) {
  return (
    <div className="space-y-10">
      ...
      {/* Calculation Modes */}
      <section>
        <h2 className="text-2xl font-bold mb-4">{t.modesTitle}</h2>
        <p className="text-muted-foreground mb-3">{t.modesIntro}</p>
