...
export function ROISEOContent({ translations: t }: ROISEOContentProps) {
  return (
    <div className="space-y-10">
      ...
      {/* Investment Types */}
      <section>
        <h2 className="text-2xl font-bold mb-4">{t.investmentTypesTitle}</h2>
        <div className="grid gap-3 sm:grid-cols-2">
          {t.investmentTypes.map((type, index) => (
      ...
      <section>
        ...
        <div className="space-y-4">
          <div className="bg-muted p-4 rounded-lg">
            <p className="text-sm text-muted-foreground mb-2">Simple ROI:</p>
            <code className="text-sm font-mono">{t.formulaContent}</code>
          </div>
          <div className="bg-muted p-4 rounded-lg">
            <p className="text-sm text-muted-foreground mb-2">Annualized ROI (CAGR):</p>
            <code className="text-sm font-mono">{t.formulaAnnualized}</code>
          </div>
        </div>
        <p className="text-muted-foreground text-sm mt-4">{t.formulaExample}</p>
      </section>
