...
export function LoanSEOContent({ translations: t }: LoanSEOContentProps) {
  return (
    <div className="space-y-10">
      ...
      {/* Loan Types */}
      <section>
        <h2 className="text-2xl font-bold mb-4">{t.loanTypesTitle}</h2>
        <div className="grid gap-3 sm:grid-cols-2">
          {t.loanTypes.map((type, index) => (
