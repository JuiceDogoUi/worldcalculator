...
export function BMISEOContent({ translations: t }: BMISEOContentProps) {
  return (
    <div className="space-y-10">
      ...
      <section>
        ...
        <div className="bg-muted p-4 rounded-lg">
          <code className="text-sm font-mono">{t.howToCalculateFormula}</code>
        </div>
      </section>
