interface StandardDeviationSEOContentProps {
  translations: {
    whatIsTitle: string
...
export function StandardDeviationSEOContent({
  translations: t,
}: StandardDeviationSEOContentProps) {
  return (
    <div className="space-y-10">
      ...
      <section>
        ...
        <p className="text-muted-foreground mb-3">{t.typesIntro}</p>
