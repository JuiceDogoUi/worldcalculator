interface MeanMedianModeSEOContentProps {
  translations: {
    whatIsTitle: string
...
export function MeanMedianModeSEOContent({
  translations: t,
}: MeanMedianModeSEOContentProps) {
  return (
    <div className="space-y-10">
      ...
      <section>
        <h2 className="text-2xl font-bold mb-4">{t.measuresTitle}</h2>
        <p className="text-muted-foreground mb-4">{t.measuresIntro}</p>
