...
export const calculators: Calculator[] = [
  ...
  // Time & Date Calculators
  {
    ...
    slug: 'age',
    category: 'time-date',
    translationKey: 'calculators.timeDate.age',
    icon: 'Calendar',
    featured: true,
    difficulty: 'easy',
    estimatedTime: 30,
    relatedCalculators: ['birthday', 'date-calculator', 'week-number'],
    lastModified: '2026-01-15',
  },
  {
    id: 'date-calculator',
    ...
    category: 'time-date',
    translationKey: 'calculators.timeDate.date-calculator',
    icon: 'Calendar',
    featured: true,
    difficulty: 'easy',
    estimatedTime: 60,
    relatedCalculators: ['age', 'business-days', 'week-number'],
    lastModified: '2026-01-15',
  },
  {
    ...
    slug: 'time-duration',
    category: 'time-date',
    translationKey: 'calculators.timeDate.time-duration',
    icon: 'Clock',
    featured: true,
    difficulty: 'easy',
    estimatedTime: 30,
    relatedCalculators: ['business-days', 'date-calculator', 'age'],
    lastModified: '2026-01-15',
  },
  {
    ...
    slug: 'business-days',
    category: 'time-date',
    translationKey: 'calculators.timeDate.business-days',
    icon: 'Briefcase',
    featured: true,
    difficulty: 'easy',
    estimatedTime: 60,
    relatedCalculators: ['date-calculator', 'time-duration', 'week-number'],
    lastModified: '2026-01-15',
  },
  {
    ...
    slug: 'birthday',
    category: 'time-date',
    translationKey: 'calculators.timeDate.birthday',
    icon: 'Cake',
    featured: true,
    difficulty: 'easy',
    estimatedTime: 30,
    relatedCalculators: ['age', 'date-calculator', 'week-number'],
    lastModified: '2026-01-15',
  },
  {
    ...
    slug: 'week-number',
    category: 'time-date',
    translationKey: 'calculators.timeDate.week-number',
    icon: 'Hash',
    featured: true,
    difficulty: 'easy',
    estimatedTime: 30,
    relatedCalculators: ['date-calculator', 'business-days', 'age'],
    lastModified: '2026-01-15',
  },
  ...
  // Construction Calculators
  {
    ...
    translationKey: 'calculators.construction.square-footage',
    icon: 'Square',
    featured: true,
    difficulty: 'easy',
    estimatedTime: 60,
    relatedCalculators: ['concrete', 'paint', 'flooring'],
    lastModified: '2026-01-16',
  },
  {
    ...
    slug: 'concrete',
    category: 'construction',
    translationKey: 'calculators.construction.concrete',
    icon: 'Box',
    featured: true,
    difficulty: 'easy',
    estimatedTime: 90,
    relatedCalculators: ['square-footage', 'gravel', 'drywall'],
    lastModified: '2026-01-16',
  },
  {
    id: 'paint-calculator',
    slug: 'paint',
    category: 'construction',
    translationKey: 'calculators.construction.paint',
    icon: 'Paintbrush',
    featured: true,
    difficulty: 'easy',
    estimatedTime: 60,
    relatedCalculators: ['square-footage', 'concrete', 'drywall'],
    lastModified: '2026-01-16',
  },
  {
    ...
    slug: 'flooring',
    category: 'construction',
    translationKey: 'calculators.construction.flooring',
    icon: 'Layers',
    featured: true,
    difficulty: 'easy',
    estimatedTime: 60,
    relatedCalculators: ['square-footage', 'paint', 'concrete'],
    lastModified: '2026-01-16',
  },
  {
    ...
    slug: 'drywall',
    category: 'construction',
    translationKey: 'calculators.construction.drywall',
    icon: 'Square',
    featured: true,
    difficulty: 'easy',
    estimatedTime: 60,
  ...
  },
  {
    ...
    slug: 'gravel',
    category: 'construction',
    translationKey: 'calculators.construction.gravel',
    icon: 'Mountain',
    featured: true,
    difficulty: 'easy',
    estimatedTime: 60,
    relatedCalculators: ['concrete', 'square-footage', 'drywall'],
    lastModified: '2026-01-16',
  },
]
